 ...
 (function($) {
	...
	*/
	...
	$
		...
		/**
		* Add gesture events inside the $.event.special namespace
		*/
		function( sInternal_, sPublicFN_ ) {
			...
			// add as funciton to $.event.special.sPublicFN_
			$.event.special[ sPublicFN_ ] = {

				/**
				* When the first event handler is bound, $ executes the setup function.
						...
						if($.hasGestures) {
							switch(_sGestureEvent) {
								...
								case 'orientationchange':
									_$element.on('orientationchange', _onOrientationchange, false);
								break;
								...
								case 'tilt':
									...
									_$element.on('devicemotion', _onDevicemotion, false);
								break;
								...
								case 'swipeleftdown':
								case 'swipeleft':
									_$element.on('touchstart', _onTouchstart, false);
								break;
								...
								case 'rotatecw' :
								case 'rotateccw' :
									_$element.on('gesturestart', _onGesturestart, false);
									_$element.on('gestureend', _onGestureend, false);
								break;
								...
								case 'rotate':
									_$element.on('gesturestart', _onGesturestart, false);
									_$element.on('gesturechange', _onGesturechange, false);
								break;
							}
						}
							...
							switch(_sGestureEvent) {
								...
								case 'swipe':
									// _$element.get(0).addEventListener('mousedown', _onTouchstart, false);
									 _$element.on('mousedown', _onTouchstart);
								break;
					...
					if (!_$element.data('ojQueryGestures') || !_$element.data('ojQueryGestures')[_sDOMEvent])  {
						...
						if($.hasGestures) {
							switch(_sGestureEvent) {
								...
								// event: orientationchange
								case 'orientationchange':
									_$element.off('orientationchange', _onOrientationchange, false);
								break;
								...
								case 'shakeupdown':
								case 'tilt':
									_$element.off('devicemotion', _onDevicemotion, false);
								break;
								...
								case 'swipeleft':
								case 'swipeleftup':
									_$element.off('touchstart', _onTouchstart, false);
									_$element.off('touchmove', _onTouchmove, false);
									_$element.off('touchend', _onTouchend, false);
								break;
								...
								case 'rotatecw' :
								case 'rotateccw' :
									_$element.off('gesturestart', _onGesturestart, false);
									_$element.off('gestureend', _onGestureend, false);
								break;
								...
								case 'rotate':
									_$element.off('gesturestart', _onGesturestart, false);
									_$element.off('gesturechange', _onGesturechange, false);
								break;
							}
						}
...
//									_$element.get(0).removeEventListener('mouseup', _onTouchend, false);
									...
									_$element.off('mousemove', _onTouchmove);
									_$element.off('mouseup', _onTouchend);
								break;
	...
	*/
	function _onTouchstart(event_) {
		...
		$.fn.triggerHandler.call(_$element,$.jGestures.events.touchstart,event_);
